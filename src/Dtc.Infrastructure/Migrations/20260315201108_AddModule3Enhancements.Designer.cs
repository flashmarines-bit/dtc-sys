...
namespace Dtc.Infrastructure.Migrations
{
    ...
    [Migration("20260315201108_AddModule3Enhancements")]
    partial class AddModule3Enhancements
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Dtc.Domain.Entities.PendingVendorRequest", b =>
                {
                    ...
                    b.Property<Guid?>("RelatedLibraryDocumentId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("RelatedLibraryDocumentId");
            ...
            modelBuilder.Entity("Dtc.Domain.Entities.PendingVendorRequest", b =>
                {
                    ...
                    b.HasOne("Dtc.Domain.Entities.Document", "RelatedLibraryDocument")
                        .WithMany()
                        .HasForeignKey("RelatedLibraryDocumentId");
                    ...
                    b.Navigation("RelatedLibraryDocument");
